...
class ChannelsConfig(Base):
    ...
    send_tool_results: bool = False  # stream each tool call result to the channel (name + result summary)
...
class Config(BaseSettings):
    ...
    model_config = ConfigDict(env_prefix="xcbot_", env_nested_delimiter="__")
